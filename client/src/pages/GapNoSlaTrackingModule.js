...
/**
 * Gap/CFS Feature Page: No SLA tracking module.
 * Slug: no-sla-tracking-module
 * Backend: /api/gap-no-sla-tracking-module
 */
export default function NoSlaTrackingModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sla-tracking-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No SLA tracking module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No SLA tracking module.</p>
