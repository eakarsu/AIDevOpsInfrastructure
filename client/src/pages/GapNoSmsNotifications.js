...
/**
 * Gap/CFS Feature Page: No SMS notifications.
 * Slug: no-sms-notifications
 * Backend: /api/gap-no-sms-notifications
 */
export default function NoSmsNotificationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sms-notifications', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No SMS notifications.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No SMS notifications.</p>
