    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-header">
          ...
          <h1 className="login-title">AI DevOps Platform</h1>
          <p className="login-subtitle">Auto-scaling, Incident Response & Deployment Agents</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input className="form-input" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="admin@devops.io" required />
          </div>
          <div className="form-group">
