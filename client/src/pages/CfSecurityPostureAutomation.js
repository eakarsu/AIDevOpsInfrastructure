...
/**
 * Gap/CFS Feature Page: Security posture automation
 * Slug: security-posture-automation
 * Backend: /api/cf-security-posture-automation
 */
export default function SecurityPostureAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-security-posture-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Security posture automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Continuous security assessment; auto-remediate common vulnerabilities.</p>
