...
/**
 * Gap/CFS Feature Page: No change-management workflow.
 * Slug: no-change-management-workflow
 * Backend: /api/gap-no-change-management-workflow
 */
export default function NoChangeManagementWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-change-management-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No change-management workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No change-management workflow.</p>
