...
/**
 * Gap/CFS Feature Page: Anomaly detection
 * Slug: anomaly-detection
 * Backend: /api/cf-anomaly-detection
 */
export default function AnomalyDetectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-anomaly-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Anomaly detection</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Monitor infrastructure metrics; alert on unusual patterns indicating potential issues.</p>
