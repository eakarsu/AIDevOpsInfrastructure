...
/**
 * Gap/CFS Feature Page: Cost optimization automation
 * Slug: cost-optimization-automation
 * Backend: /api/cf-cost-optimization-automation
 */
export default function CostOptimizationAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-cost-optimization-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Cost optimization automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Recommend and auto-implement cost savings (spot instances, reserved capacity, right-sizing).</p>
